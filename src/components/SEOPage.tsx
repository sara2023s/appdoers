        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Outrank Your Competition. Dominate Google. Grow Revenue.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto mb-12">
              Top-tier SEO strategies that put your business where it belongs: at the top.
            </p>
            <motion.button
              ...
              <div className="h-64 flex items-end space-x-4">
                {[20, 40, 60, 80, 100].map((height, index) => (
                  <motion.div
                    ...
                    className="w-12 bg-gradient-to-t from-[#1dd3b0] to-[#affc41] rounded-t-lg"
                  />
                ))}
              </div>
            </div>
